...
urlpatterns = [
    ...
    path('get-test-students/', views.get_test_students, name='get_test_students'),
    ...
    path('review-processed-sheets/save/', views.save_reviewed_sheets, name='save_reviewed_sheets'),
